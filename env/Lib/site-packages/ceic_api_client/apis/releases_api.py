...
class ReleasesApi(object):
    ...
    def get_release_series(self, code, **kwargs):  # noqa: E501
        """List release code series.  # noqa: E501

        Lists the series for a specific release identifier code.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_release_series(code, async_req=True)
        >>> result = thread.get()
        ...
        :return: ReleaseSeriesResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_release_series_with_http_info(code, **kwargs)  # noqa: E501
        else:
            (data) = self.get_release_series_with_http_info(code, **kwargs)  # noqa: E501
            return data

    def get_release_series_with_http_info(self, code, **kwargs):  # noqa: E501
        """List release code series.  # noqa: E501

        Lists the series for a specific release identifier code.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_release_series_with_http_info(code, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method get_release_series" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('code' not in params or
                params['code'] is None):
            raise ValueError("Missing the required parameter `code` when calling `get_release_series`")  # noqa: E501

        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_release_series`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_release_series`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            response_type='ReleaseSeriesResult',  # noqa: E501
    ...
    def get_series_releases(self, id, **kwargs):  # noqa: E501
        """List of releases for a single series id  # noqa: E501

        Lists the release schedule for a single series id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_series_releases(id, async_req=True)
        >>> result = thread.get()
        ...
        :param float offset: The offset from which the records will be returned. Used to get the next set of records when the limit is reached.
        :param float limit: Number of records to return in the range 1 - 100. Default is 100.
        :return: SeriesReleaseScheduleSearchResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.get_series_releases_with_http_info(id, **kwargs)  # noqa: E501
        else:
            (data) = self.get_series_releases_with_http_info(id, **kwargs)  # noqa: E501
            return data

    def get_series_releases_with_http_info(self, id, **kwargs):  # noqa: E501
        """List of releases for a single series id  # noqa: E501

        Lists the release schedule for a single series id  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.get_series_releases_with_http_info(id, async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_series_releases" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('id' not in params or
                params['id'] is None):
            raise ValueError("Missing the required parameter `id` when calling `get_series_releases`")  # noqa: E501

        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_series_releases`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_series_releases`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='SeriesReleaseScheduleSearchResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def search_series_releases(self, **kwargs):  # noqa: E501
        """Released schedule search  # noqa: E501

        Allows searching for series' release schedule by a keyword and additional filtering criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_series_releases(async_req=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async_req'):
            return self.search_series_releases_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.search_series_releases_with_http_info(**kwargs)  # noqa: E501
            return data

    def search_series_releases_with_http_info(self, **kwargs):  # noqa: E501
        """Released schedule search  # noqa: E501

        Allows searching for series' release schedule by a keyword and additional filtering criteria.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.search_series_releases_with_http_info(async_req=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method search_series_releases" % key
                )
            params[key] = val
        del params['kwargs']

        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `search_series_releases`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `search_series_releases`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
