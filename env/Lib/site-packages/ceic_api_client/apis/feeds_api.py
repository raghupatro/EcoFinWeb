...
class FeedsApi(object):
    ...
    def create_feed(self, filter_id, **kwargs):  # noqa: E501
        """Subscribe for a feed  # noqa: E501

        Creates a request for a feed subscription.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_feed(filter_id, async_req=True)
        >>> result = thread.get()
        ...
        :param int frequency: Feed generation frequency
        :param bool full_dump: When set to true, the feed will always generate full list of time points. This option is only available for lists that are equal or less than 3,000 series.
        :return: FeedResult
        ...
        if kwargs.get('async_req'):
            return self.create_feed_with_http_info(filter_id, **kwargs)  # noqa: E501
        else:
            (data) = self.create_feed_with_http_info(filter_id, **kwargs)  # noqa: E501
            return data

    def create_feed_with_http_info(self, filter_id, **kwargs):  # noqa: E501
        """Subscribe for a feed  # noqa: E501

        Creates a request for a feed subscription.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        >>> thread = api.create_feed_with_http_info(filter_id, async_req=True)
        >>> result = thread.get()
        ...
        all_params = ['filter_id', 'accept_language', 'accept', 'lang', 'format', 'token', 'with_model_information', 'name', 'description', 'consolidation', 'delivery', 'user_ftp_url', 'user_ftp_path', 'user_ftp_username', 'user_ftp_password', 'notification_email', 'notification_url', 'notification_http_method', 'frequency', 'full_dump']  # noqa: E501
        ...
        if ('filter_id' not in params or
            ...
            raise ValueError("Missing the required parameter `filter_id` when calling `create_feed`")  # noqa: E501
        ...
        if 'full_dump' in params:
            form_params.append(('full_dump', params['full_dump']))  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            response_type='FeedResult',  # noqa: E501
    ...
    def delete_feed_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FeedInformation',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_feed(self, id, **kwargs):  # noqa: E501
        ...
        Get a single data feed record  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def get_feeds(self, **kwargs):  # noqa: E501
        """List all feed subscriptions  # noqa: E501

        List all feed subscriptions the user have set.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
        ...
        :param list[str] status: Feed status
        :return: FeedsResult
                 If the method is called asynchronously,
                 returns the request thread.
        """
    ...
    def get_feeds_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['accept_language', 'accept', 'lang', 'format', 'token', 'with_model_information', 'offset', 'limit', 'created_after', 'created_before', 'filter_id', 'created_order', 'status']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'limit' in params and params['limit'] > 100:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_feeds`, must be a value less than or equal to `100`")  # noqa: E501
        if 'limit' in params and params['limit'] < 1:  # noqa: E501
            raise ValueError("Invalid value for parameter `limit` when calling `get_feeds`, must be a value greater than or equal to `1`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='FeedsResult',  # noqa: E501
            auth_settings=auth_settings,
            async_req=params.get('async_req'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def update_feed(self, id, **kwargs):  # noqa: E501
        ...
        Update an already existing feed.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async_req=True
    ...
    def update_feed_with_http_info(self, id, **kwargs):  # noqa: E501
        ...
        all_params = ['id', 'accept_language', 'accept', 'lang', 'format', 'token', 'with_model_information', 'name', 'description', 'consolidation', 'delivery', 'user_ftp_url', 'user_ftp_path', 'user_ftp_username', 'user_ftp_password', 'notification_email', 'notification_url', 'notification_http_method', 'frequency', 'full_dump', 'status', 'filter_id']  # noqa: E501
        all_params.append('async_req')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
