...
class LayoutApi(object):
    ...
    def get_layout_databases_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['accept_language', 'accept', 'lang', 'format', 'token', 'with_model_information', 'keyword', 'frequency', 'country', 'source', 'unit', 'indicator', 'region', 'subscribed_only', 'key_only', 'new_only', 'name_only', 'start_date_before', 'end_date_after', 'created_after', 'updated_after', 'geo', 'status', 'filter_id']  # noqa: E501
