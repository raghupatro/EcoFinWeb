...
class ApiClient(object):
    ...
    PRIMITIVE_TYPES_SERIALIZATION_MAPPING = {
        bool: lambda obj: str(obj).lower()
    }

    def __init__(self, host=None, configuration=None, header_name=None, header_value=None,
                 cookie=None):
        ...
        self.user_agent = 'Swagger-Codegen/2.8.12.234/python'
    ...
    def sanitize_for_serialization(self, obj):
        ...
        If obj is str, int, long, float, bool, return serialized obj.
        ...
        if obj is None:
            ...
            return self.__serialize_primitive_type_value(obj)
    ...
    def __deserialize(self, data, klass):
        ...
        if type(klass) == str:
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(ceic_api_client.models, klass)
    ...
    def __deserialize_primitive(self, data, klass):
        ...
        try:
            ...
            value = self.__deserialize_primitive_unicode(data)
        except TypeError:
            value = data

        return value

    def __deserialize_primitive_unicode(self, data):
        try:
            value = six.u(data)
        except TypeError:
            try:
    ...
    def __serialize_primitive_type_value(self, value):
        """Serialize a primitive type value.
        ...
        try:
            serialize_func = self.PRIMITIVE_TYPES_SERIALIZATION_MAPPING[type(value)]
