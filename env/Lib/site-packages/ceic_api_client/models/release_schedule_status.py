...
class ReleaseScheduleStatus(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """ReleaseScheduleStatus - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this ReleaseScheduleStatus.  # noqa: E501

        The ID of the status of the release schedule.  0 - None 1 - Pending 2 - Delayed 3 - Released  # noqa: E501

        :return: The id of this ReleaseScheduleStatus.  # noqa: E501
        :rtype: float
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this ReleaseScheduleStatus.

        The ID of the status of the release schedule.  0 - None 1 - Pending 2 - Delayed 3 - Released  # noqa: E501

        :param id: The id of this ReleaseScheduleStatus.  # noqa: E501
        :type: float
        """
    ...
    @property
    def name(self):
        """Gets the name of this ReleaseScheduleStatus.  # noqa: E501

        The status name  # noqa: E501

        :return: The name of this ReleaseScheduleStatus.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this ReleaseScheduleStatus.

        The status name  # noqa: E501

        :param name: The name of this ReleaseScheduleStatus.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReleaseScheduleStatus):
            return False
