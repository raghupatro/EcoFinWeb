...
class IndicatorsResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """IndicatorsResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this IndicatorsResult.  # noqa: E501

        An array of indicators  # noqa: E501

        :return: The data of this IndicatorsResult.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this IndicatorsResult.

        An array of indicators  # noqa: E501

        :param data: The data of this IndicatorsResult.  # noqa: E501
        :type: list[Indicator]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, IndicatorsResult):
            return False
