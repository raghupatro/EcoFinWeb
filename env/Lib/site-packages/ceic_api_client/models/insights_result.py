...
class InsightsResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """InsightsResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this InsightsResult.  # noqa: E501

        An array of insights  # noqa: E501

        :return: The data of this InsightsResult.  # noqa: E501
        :rtype: list[Insights]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this InsightsResult.

        An array of insights  # noqa: E501

        :param data: The data of this InsightsResult.  # noqa: E501
        :type: list[Insights]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsightsResult):
            return False
