...
class FrequenciesResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """FrequenciesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this FrequenciesResult.  # noqa: E501

        An array of frequencies  # noqa: E501

        :return: The data of this FrequenciesResult.  # noqa: E501
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this FrequenciesResult.

        An array of frequencies  # noqa: E501

        :param data: The data of this FrequenciesResult.  # noqa: E501
        :type: list[Frequency]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FrequenciesResult):
            return False
