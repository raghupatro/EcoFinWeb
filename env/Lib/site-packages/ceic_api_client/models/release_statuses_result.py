...
from ceic_api_client.models.release_schedule_status import ReleaseScheduleStatus  # noqa: F401,E501


class ReleaseStatusesResult(object):
    ...
    """
    swagger_types = {
        'data': 'list[ReleaseScheduleStatus]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """ReleaseStatusesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ReleaseStatusesResult.  # noqa: E501


        :return: The data of this ReleaseStatusesResult.  # noqa: E501
        :rtype: list[ReleaseScheduleStatus]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ReleaseStatusesResult.


        :param data: The data of this ReleaseStatusesResult.  # noqa: E501
        :type: list[ReleaseScheduleStatus]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReleaseStatusesResult):
            return False
