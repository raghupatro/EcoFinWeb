...
class FeedResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """FeedResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this FeedResult.  # noqa: E501


        :return: The data of this FeedResult.  # noqa: E501
        :rtype: FeedInformation
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this FeedResult.


        :param data: The data of this FeedResult.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedResult):
            return False
