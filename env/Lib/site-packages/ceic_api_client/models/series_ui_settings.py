...
class SeriesUISettings(object):
    ...
    swagger_types = {
        'display_order': 'float',
        'separator_after_series': 'bool'
    }

    attribute_map = {
        'display_order': 'displayOrder',
        'separator_after_series': 'separatorAfterSeries'
    }

    def __init__(self, display_order=None, separator_after_series=None):  # noqa: E501
        """SeriesUISettings - a model defined in Swagger"""  # noqa: E501

        self._display_order = None
        self._separator_after_series = None
        self.discriminator = None

        if display_order is not None:
            self.display_order = display_order
        if separator_after_series is not None:
            self.separator_after_series = separator_after_series

    @property
    def display_order(self):
        """Gets the display_order of this SeriesUISettings.  # noqa: E501

        Indicates the position of the series within the table  # noqa: E501

        :return: The display_order of this SeriesUISettings.  # noqa: E501
        :rtype: float
        """
    ...
    def display_order(self, display_order):
        """Sets the display_order of this SeriesUISettings.

        Indicates the position of the series within the table  # noqa: E501

        :param display_order: The display_order of this SeriesUISettings.  # noqa: E501
        :type: float
        """
    ...
    @property
    def separator_after_series(self):
        """Gets the separator_after_series of this SeriesUISettings.  # noqa: E501

        Indicates whether separator should be located after this series  # noqa: E501

        :return: The separator_after_series of this SeriesUISettings.  # noqa: E501
        :rtype: bool
        """
        return self._separator_after_series

    @separator_after_series.setter
    def separator_after_series(self, separator_after_series):
        """Sets the separator_after_series of this SeriesUISettings.

        Indicates whether separator should be located after this series  # noqa: E501

        :param separator_after_series: The separator_after_series of this SeriesUISettings.  # noqa: E501
        :type: bool
        """

        self._separator_after_series = separator_after_series
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SeriesUISettings):
            return False
