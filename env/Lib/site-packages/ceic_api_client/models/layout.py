...
class Layout(object):
    ...
    def __init__(self, parent_id=None, id=None, name=None):  # noqa: E501
    ...
    @property
    def parent_id(self):
        """Gets the parent_id of this Layout.  # noqa: E501
    ...
    def parent_id(self, parent_id):
        """Sets the parent_id of this Layout.
        ...
        :type: str
        """
        allowed_values = ["WORLD", "GLOBAL"]  # noqa: E501

        parent_id = self._parse_enum_value(parent_id, allowed_values)
        if parent_id not in allowed_values:
            raise ValueError(
                "Invalid value for `parent_id` ({0}), must be one of {1}"  # noqa: E501
                .format(parent_id, allowed_values)
            )
    ...
    def id(self, id):
        ...
        allowed_values = ["WORLD", "WGEM", "WAEM", "WFOR", "WCOM", "WCOC", "WAGR", "WASS", "WIT10", "GLOBAL", "AA", "ECA", "MEA", "NSA", "CEICGLBKS", "PMI", "DAILY", "BRAZIL", "RUSSIA", "INDIA", "INDONESIA", "CN"]  # noqa: E501
