...
class RegionsResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """RegionsResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this RegionsResult.  # noqa: E501

        An array of regions  # noqa: E501

        :return: The data of this RegionsResult.  # noqa: E501
        :rtype: list[Region]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this RegionsResult.

        An array of regions  # noqa: E501

        :param data: The data of this RegionsResult.  # noqa: E501
        :type: list[Region]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, RegionsResult):
            return False
