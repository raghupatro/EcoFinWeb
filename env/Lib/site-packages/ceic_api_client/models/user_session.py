...
class UserSession(object):
    ...
    @property
    def session(self):
        """Gets the session of this UserSession.  # noqa: E501

        The user session identifier to be used by the `token` query parameter or `Authorization` header.  # noqa: E501

        :return: The session of this UserSession.  # noqa: E501
        :rtype: str
        """
    ...
    def session(self, session):
        """Sets the session of this UserSession.

        The user session identifier to be used by the `token` query parameter or `Authorization` header.  # noqa: E501

        :param session: The session of this UserSession.  # noqa: E501
        :type: str
        """
