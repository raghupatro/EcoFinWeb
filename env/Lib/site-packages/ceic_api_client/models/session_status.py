...
class SessionStatus(object):
    ...
    def __init__(self, destroyed=None, session=None):  # noqa: E501
        """SessionStatus - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def destroyed(self):
        """Gets the destroyed of this SessionStatus.  # noqa: E501

        Indicates whether the session is active or not  # noqa: E501

        :return: The destroyed of this SessionStatus.  # noqa: E501
        :rtype: bool
        """
    ...
    def destroyed(self, destroyed):
        """Sets the destroyed of this SessionStatus.

        Indicates whether the session is active or not  # noqa: E501

        :param destroyed: The destroyed of this SessionStatus.  # noqa: E501
        :type: bool
        """
    ...
    @property
    def session(self):
        """Gets the session of this SessionStatus.  # noqa: E501

        The user session identifier  # noqa: E501

        :return: The session of this SessionStatus.  # noqa: E501
        :rtype: str
        """
    ...
    def session(self, session):
        """Sets the session of this SessionStatus.

        The user session identifier  # noqa: E501

        :param session: The session of this SessionStatus.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SessionStatus):
            return False
