...
from ceic_api_client.models.layout_full_metadata_item import LayoutFullMetadataItem  # noqa: F401,E501


class LayoutFullMetadataResult(object):
    ...
    """
    swagger_types = {
        'data': 'list[LayoutFullMetadataItem]'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """LayoutFullMetadataResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this LayoutFullMetadataResult.  # noqa: E501

        An array of layout full metadata items  # noqa: E501

        :return: The data of this LayoutFullMetadataResult.  # noqa: E501
        :rtype: list[LayoutFullMetadataItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this LayoutFullMetadataResult.

        An array of layout full metadata items  # noqa: E501

        :param data: The data of this LayoutFullMetadataResult.  # noqa: E501
        :type: list[LayoutFullMetadataItem]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LayoutFullMetadataResult):
            return False
