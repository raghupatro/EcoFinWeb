...
class StatusesResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """StatusesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this StatusesResult.  # noqa: E501

        An array of statuses  # noqa: E501

        :return: The data of this StatusesResult.  # noqa: E501
        :rtype: list[Status]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this StatusesResult.

        An array of statuses  # noqa: E501

        :param data: The data of this StatusesResult.  # noqa: E501
        :type: list[Status]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, StatusesResult):
            return False
