...
class LayoutItemMetadata(object):
    ...
    def __init__(self, id=None, name=None):  # noqa: E501
        """LayoutItemMetadata - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def id(self):
        """Gets the id of this LayoutItemMetadata.  # noqa: E501

        The layout item ID  # noqa: E501

        :return: The id of this LayoutItemMetadata.  # noqa: E501
        :rtype: str
        """
        return self._id
    ...
    @id.setter
    def id(self, id):
        """Sets the id of this LayoutItemMetadata.

        The layout item ID  # noqa: E501

        :param id: The id of this LayoutItemMetadata.  # noqa: E501
        :type: str
        """
    ...
    @property
    def name(self):
        """Gets the name of this LayoutItemMetadata.  # noqa: E501

        The layout item name  # noqa: E501

        :return: The name of this LayoutItemMetadata.  # noqa: E501
        :rtype: str
        """
        return self._name
    ...
    @name.setter
    def name(self, name):
        """Sets the name of this LayoutItemMetadata.

        The layout item name  # noqa: E501

        :param name: The name of this LayoutItemMetadata.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LayoutItemMetadata):
            return False
