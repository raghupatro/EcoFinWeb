...
from ceic_api_client.models.dictionary_data import DictionaryData  # noqa: F401,E501
...
class DictionaryResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """DictionaryResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this DictionaryResult.  # noqa: E501

        An array of dictionary data  # noqa: E501

        :return: The data of this DictionaryResult.  # noqa: E501
        :rtype: list[DictionaryData]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this DictionaryResult.

        An array of dictionary data  # noqa: E501

        :param data: The data of this DictionaryResult.  # noqa: E501
        :type: list[DictionaryData]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, DictionaryResult):
            return False
