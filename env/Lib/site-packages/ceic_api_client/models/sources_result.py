...
class SourcesResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """SourcesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this SourcesResult.  # noqa: E501

        An array of sources  # noqa: E501

        :return: The data of this SourcesResult.  # noqa: E501
        :rtype: list[Source]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this SourcesResult.

        An array of sources  # noqa: E501

        :param data: The data of this SourcesResult.  # noqa: E501
        :type: list[Source]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, SourcesResult):
            return False
