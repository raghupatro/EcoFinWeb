...
from ceic_api_client.models.feed_information import FeedInformation  # noqa: F401,E501


class FeedsResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """FeedsResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this FeedsResult.  # noqa: E501


        :return: The data of this FeedsResult.  # noqa: E501
        :rtype: list[FeedInformation]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this FeedsResult.


        :param data: The data of this FeedsResult.  # noqa: E501
        :type: list[FeedInformation]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FeedsResult):
            return False
