...
class WatchlistProcessedInformation(object):
    ...
    def __init__(self, processed_items=None):  # noqa: E501
        """WatchlistProcessedInformation - a model defined in Swagger"""  # noqa: E501
    ...
    def processed_items(self):
        """Gets the processed_items of this WatchlistProcessedInformation.  # noqa: E501

        The number of the items that were processed  # noqa: E501

        :return: The processed_items of this WatchlistProcessedInformation.  # noqa: E501
        :rtype: int
        """
        return self._processed_items

    @processed_items.setter
    def processed_items(self, processed_items):
        """Sets the processed_items of this WatchlistProcessedInformation.

        The number of the items that were processed  # noqa: E501

        :param processed_items: The processed_items of this WatchlistProcessedInformation.  # noqa: E501
        :type: int
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatchlistProcessedInformation):
            return False
