...
from ceic_api_client.models.series_filter import SeriesFilter  # noqa: F401,E501


class FiltersResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """FiltersResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this FiltersResult.  # noqa: E501

        An array of series filters  # noqa: E501

        :return: The data of this FiltersResult.  # noqa: E501
        :rtype: list[SeriesFilter]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this FiltersResult.

        An array of series filters  # noqa: E501

        :param data: The data of this FiltersResult.  # noqa: E501
        :type: list[SeriesFilter]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, FiltersResult):
            return False
