...
from ceic_api_client.models.release_schedule_type import ReleaseScheduleType  # noqa: F401,E501


class ReleaseTypesResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """ReleaseTypesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this ReleaseTypesResult.  # noqa: E501


        :return: The data of this ReleaseTypesResult.  # noqa: E501
        :rtype: list[ReleaseScheduleType]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this ReleaseTypesResult.


        :param data: The data of this ReleaseTypesResult.  # noqa: E501
        :type: list[ReleaseScheduleType]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, ReleaseTypesResult):
            return False
