...
class UnitsResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """UnitsResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UnitsResult.  # noqa: E501

        An array of units  # noqa: E501

        :return: The data of this UnitsResult.  # noqa: E501
        :rtype: list[Unit]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this UnitsResult.

        An array of units  # noqa: E501

        :param data: The data of this UnitsResult.  # noqa: E501
        :type: list[Unit]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UnitsResult):
            return False
