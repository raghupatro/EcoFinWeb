...
class InsightsCategoriesResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """InsightsCategoriesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this InsightsCategoriesResult.  # noqa: E501

        An array of insights categories  # noqa: E501

        :return: The data of this InsightsCategoriesResult.  # noqa: E501
        :rtype: list[InsightsCategory]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this InsightsCategoriesResult.

        An array of insights categories  # noqa: E501

        :param data: The data of this InsightsCategoriesResult.  # noqa: E501
        :type: list[InsightsCategory]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, InsightsCategoriesResult):
            return False
