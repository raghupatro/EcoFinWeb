...
class CountriesResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """CountriesResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this CountriesResult.  # noqa: E501

        An array of countries  # noqa: E501

        :return: The data of this CountriesResult.  # noqa: E501
        :rtype: list[Country]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this CountriesResult.

        An array of countries  # noqa: E501

        :param data: The data of this CountriesResult.  # noqa: E501
        :type: list[Country]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, CountriesResult):
            return False
