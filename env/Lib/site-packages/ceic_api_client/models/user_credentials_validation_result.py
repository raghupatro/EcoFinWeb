...
from ceic_api_client.models.user_credentials_validation_result_data import UserCredentialsValidationResultData  # noqa: F401,E501


class UserCredentialsValidationResult(object):
    ...
    """
    swagger_types = {
        'data': 'UserCredentialsValidationResultData'
    }
    ...
    def __init__(self, data=None):  # noqa: E501
        """UserCredentialsValidationResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this UserCredentialsValidationResult.  # noqa: E501


        :return: The data of this UserCredentialsValidationResult.  # noqa: E501
        :rtype: UserCredentialsValidationResultData
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this UserCredentialsValidationResult.


        :param data: The data of this UserCredentialsValidationResult.  # noqa: E501
        :type: UserCredentialsValidationResultData
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, UserCredentialsValidationResult):
            return False
