...
class LayoutsResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """LayoutsResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this LayoutsResult.  # noqa: E501

        An array of layouts  # noqa: E501

        :return: The data of this LayoutsResult.  # noqa: E501
        :rtype: list[Layout]
        """
        return self._data
    ...
    @data.setter
    def data(self, data):
        """Sets the data of this LayoutsResult.

        An array of layouts  # noqa: E501

        :param data: The data of this LayoutsResult.  # noqa: E501
        :type: list[Layout]
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, LayoutsResult):
            return False
