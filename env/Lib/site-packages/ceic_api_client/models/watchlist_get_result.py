...
from ceic_api_client.models.watchlist_item import WatchlistItem  # noqa: F401,E501


class WatchlistGetResult(object):
    ...
    def __init__(self, data=None):  # noqa: E501
        """WatchlistGetResult - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def data(self):
        """Gets the data of this WatchlistGetResult.  # noqa: E501


        :return: The data of this WatchlistGetResult.  # noqa: E501
        :rtype: list[WatchlistItem]
        """
        return self._data

    @data.setter
    def data(self, data):
        """Sets the data of this WatchlistGetResult.


        :param data: The data of this WatchlistGetResult.  # noqa: E501
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, WatchlistGetResult):
            return False
